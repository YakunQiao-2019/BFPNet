%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Evaluation tool boxs for PraNet: Parallel Reverse Attention Network for Polyp Segmentation (MICCAI20, Oral).
...
ResultMapPath = '../result_mask/seg_maps';
Models = {'mineNet'}; %Models = {'UNet','UNet++','PraNet','SFA'}; 
modelNum = length(Models);

% ---- 2. Ground-truth Datasets Setting ----
DataPath = '../../../../DataSets/TestDataset/';
Datasets = {'CVC-300', 'CVC-ClinicDB', 'CVC-ColonDB','ETIS-LaribPolypDB', 'Kvasir'}; %Datasets = {'CVC-ClinicDB', 'CVC-ColonDB','ETIS-LaribPolypDB', 'Kvasir','CVC-300'}; 

% ---- 3. Evaluation Results Save Path Setting ----
ResDir = '../result_mask/seg_result/';
ResName='_result.txt';  % You can change the re sult name.
